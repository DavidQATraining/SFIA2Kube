...
docker service update --image service_1:latest service_2
docker service update --image service_1:latest service_3
docker service update --image service_1:latest service_4